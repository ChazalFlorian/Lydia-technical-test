...
class UserListAdapter(private val users: ArrayList<UserViewModel>) :
    ...
    override fun onBindViewHolder(holder: UserHolder, position: Int) = holder.bind(users[position], ((position % 2 ) == 0))
